...
function solution(numbers, left, right) {
  ...
  for (let i = 0; i < numbers.length; i++) {
    ...
    // console.log(numbers[i], "/", (i+1),"---",left,"<", x, ">", right);
    if (x - Math.floor(x) !== 0){
      result.push(false);
...
// Tests
// console.log(solution([8, 5, 6, 16, 5],1,3)); //[false, false, true, false, true]
// console.log(solution([100],1,1000));//[true]
// console.log(solution([1, 2, 3, 4, 5],2,10000));//[false, false, false, false, false]
// console.log(solution([65, 46, 60, 164, 243, 228, 231, 298, 231, 211],20,50));//[false, true, true, true, false, true, true, false, false, false]
// console.log(solution([643, 531, 504, 224, 415, 360, 364, 84, 212, 587],70,80));//[false, false, false, false, false, false, false, false, false, false]